...
+ (void)hsShowCenterWithText:(NSString *)text {
    [HSToast hsShowCenterWithText:text duration:ToastDispalyDuration];
}
...
+ (void)hsShowTopWithText:(NSString *)text {
    [HSToast hsShowTopWithText:text topOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowTopWithText:(NSString *)text duration:(CGFloat)duration {
    [HSToast hsShowTopWithText:text topOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowTopWithText:(NSString *)text topOffset:(CGFloat)topOffset {
    [HSToast hsShowTopWithText:text topOffset:topOffset duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text {
    [HSToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text duration:(CGFloat)duration {
    [HSToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset {
    [HSToast hsShowBottomWithText:text bottomOffset:bottomOffset duration:ToastDispalyDuration];
}
