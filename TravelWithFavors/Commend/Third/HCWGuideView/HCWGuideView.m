        ...
        for (int i=0; i<self.imageNames.count; i++) {
            ...
            if (i == self.imageNames.count - 1) {
                if (!self.enterButtonHidden) {
                    ...
                    UIButton *enterButton = [[UIButton alloc] initWithFrame:CGRectMake((kScreenWidth-100)/2, 1150 / 1334.0 * kScreenHeight, 100, 30)];
                    ...
                    enterButton.layer.borderColor = [UIColor hdMainColor].CGColor;
                    enterButton.layer.borderWidth = 1;
                    [enterButton setTitleColor:[UIColor hdMainColor] forState:0];
