...
#define COLOR_THEME ([UIColor colorWithHexString:@"#333333"])
...
- (void)initWithHeader
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(20.f, 40.0f, 100, 30.f)];
//    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:32.0f]];
    self.masterLabel = masterLabel;
    self.masterLabel.textColor = [UIColor colorWithHexString:@"#333333"];
    [self addSubview:self.masterLabel];

    UILabel *yearLabel = [[UILabel alloc] initWithFrame:CGRectMake(headerWidth - 120, 40.0f, 100, 30.f)];
        [yearLabel setTextAlignment:NSTextAlignmentRight];
    [yearLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16.0f]];
    self.yearLabel = yearLabel;
    self.yearLabel.textColor = [UIColor colorWithHexString:@"#333333"];
    [self addSubview:self.yearLabel];
    

    CGFloat yOffset = CGRectGetMaxY(masterLabel.frame) + 35;
