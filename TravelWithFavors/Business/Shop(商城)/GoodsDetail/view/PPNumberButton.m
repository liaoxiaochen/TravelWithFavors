...
- (void)setupUI
{
    ...
    _textField.textColor = [UIColor hdTextColor];
    if (self.decimalNum) {
...
- (void)setBorderColor:(UIColor *)borderColor{
    ...
    self.layer.borderColor = [borderColor CGColor];
      ...
      [_decreaseBtn setTitleColor:[UIColor hdPlaceHolderColor] forState:UIControlStateNormal];
      [_increaseBtn setTitleColor:[UIColor hdTextColor] forState:UIControlStateNormal];
}
